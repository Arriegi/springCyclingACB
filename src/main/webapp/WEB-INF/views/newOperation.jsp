			...
			<div class="container-fluid">
				<div class="row">
					<div class="col-lg-12 col-md-12">
						<h1>Operazio berria</h1>
					</div>
				</div>
				<form:form class="form-horizontal" method="post"
					modelAttribute="operation" action="newOperation.html">
					<form:hidden path="id" />
					...
					<spring:bind path="operationType">
						<div class="form-group ${status.error ? 'has-error' : ''}">
							<label class="col-sm-2 control-label">Operazio mota</label>
							<div class="col-sm-5">
								<form:select path="operationType" class="form-control">
									<form:options items="${operationTypes}" itemValue="id"
										itemLabel="name" />
								</form:select>
								<form:errors path="operationType" class="control-label" />
							</div>
