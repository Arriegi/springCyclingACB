...
$(".modal.confirm h4.modal-title").text("Materiala ezabatu");
$(".modal.confirm .modal-body p").text("Ziur materiala ezabatu nahi duzula?");

var DELETE_BUTTON_CLASS = "delete-material";
var href = "";
