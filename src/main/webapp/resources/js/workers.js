...
$(".modal.confirm h4.modal-title").text("Langilea ezabatu");
$(".modal.confirm .modal-body p").text("Ziur langilea ezabatu nahi duzula?");

var DELETE_BUTTON_CLASS = "delete-worker";
var href = "";
