...
$(".modal.confirm h4.modal-title").text("Sekzioa ezabatu");
$(".modal.confirm .modal-body p").text("Ziur sekzioa ezabatu nahi duzula?");

var DELETE_BUTTON_CLASS = "delete-section";
var href = "";
