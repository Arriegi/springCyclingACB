...
$(".modal.confirm h4.modal-title").text("Bezeroa ezabatu");
$(".modal.confirm .modal-body p").text("Ziur bezeroa ezabatu nahi duzula?");

var DELETE_BUTTON_CLASS = "delete-client";
var href = "";
