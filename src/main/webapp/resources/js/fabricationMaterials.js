...
$(".modal.confirm h4.modal-title").text("Fabrikazio materiala ezabatu");
$(".modal.confirm .modal-body p").text("Ziur fabrikazio materiala ezabatu nahi duzula?");

var DELETE_BUTTON_CLASS = "delete-fabrication-material";
var href = "";
